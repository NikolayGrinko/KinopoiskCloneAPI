//
//  SalessCollectionViewCell.swift
//  KinopoiskCloneAPI
//
...
class SalessCollectionViewCell : UICollectionViewCell {
    ...
    func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            categoryLabel2.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -15),
